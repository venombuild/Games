(function (global) {
  ...
  const HEROES = {
    ironman: {
      ...
      power: { type: "beam", name: "Unibeam", damage: 11, range: 150, interval: 3.3, windup: 0.4 }
    },
    cap: {
      id: "cap", name: "Captain America", abbr: "CA", color: "#1e4a8c", hp: 113,
      power: {
        type: "shield", name: "Shield Throw", interval: 4.3, windup: 0.35,
        shieldDamage: 7, shieldLife: 2.3, damageReduction: 0.5, buffTime: 5,
        holdDamage: 4, holdInterval: 2.4,
        trailDamage: 0.9, trailLife: 1.2, trailRadius: 18, trailSpacing: 28
      }
    },
    thor: {
      id: "thor", name: "Thor", abbr: "TH", color: "#6b4ce6", hp: 104,
      power: {
        type: "hammer", name: "Mjolnir", interval: 4.65,
        meleeDamage: 4, meleeInterval: 2.35,
        hammerDamage: 6.5, boomerangRange: 153,
        wallSlamDamage: 3, returnImpactDamage: 3
      }
    },
    hulk: {
      id: "hulk", name: "Hulk", abbr: "HK", color: "#3d8b37", hp: 126,
      power: { type: "touch", name: "Smash", damage: 17, interval: 3.5 }
    },
    spiderman: {
      id: "spiderman", name: "Spider-Man", abbr: "SM", color: "#c81e28", hp: 104, speedMult: 1.1,
      power: { type: "web", name: "Web Barrage", interval: 3.65, webs: 4, webSpeed: 196, webDmg: 4.6, webLife: 2.8, webR: 18, slow: 1.15 }
    },
    rocket: {
    ...
    cyclops: {
      ...
      power: { type: "spinbeam", name: "Optic Blast", interval: 1, rotSpeed: 1.15, width: 17, damage: 4.8, hitCd: 0.2 }
    },
    invisiblewoman: {
      id: "invisiblewoman", name: "Invisible Woman", abbr: "IW", color: "#39a4c4", hp: 107,
      power: { type: "force", name: "Force Field", interval: 2.6, range: 146, damage: 5, phaseInterval: 8.6, phaseDuration: 2.3 }
    },
    namor: {
      id: "namor", name: "Namor", abbr: "NM", color: "#2fa07a", hp: 107,
      power: { type: "trident", name: "Trident", interval: 3.3, dmg: 8.3, tridentSpeed: 236, tridentR: 7, stun: 0.43, maxActive: 4 }
    }
  };
